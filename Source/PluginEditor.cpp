    ...
    verticalGradientMeterR([&]() { return audioProcessor.getRmsValue(1); })
{
    ...
    depthSlider.setRange(0.0, 10000.0, 10.0);
    depthSlider.setTextBoxStyle(juce::Slider::TextBoxBelow, true, 64, 30);
    depthSlider.setLookAndFeel(&rotarySliderLookandFeel);
    depthSlider.setValue(1700.0);
    ...
    gainSlider.setRange(0.0, 5.0, 0.05);
...
void WahAudioProcessorEditor::resized()
{
    ...
    // gainSlider.setBounds(getWidth() - 300, getHeight() * 0.2, 1.15 * rotarySize, 1.15 * rotarySize);
     ...
     depthSlider.setBounds(sliderSection.removeFromRight(120).reduced(10));
...
{
    audioProcessor.toggle_humanizer();
}
...
{   
    if (firstCurrentVowel == vowel[0]) {
        ...
        audioProcessor.set_firstVowel(1);
    }
        ...
        audioProcessor.set_firstVowel(2);
    }
        ...
        audioProcessor.set_firstVowel(3);
    }
        ...
        audioProcessor.set_firstVowel(4);
    }
    else if (firstCurrentVowel == vowel[4]) {
        firstVowel.setButtonText("A");
        firstVowel.setColour(juce::TextButton::buttonOnColourId, juce::Colours::red.darker(0.2f));
        firstCurrentVowel = vowel[0];
        audioProcessor.set_firstVowel(0);
    }
}
...
void WahAudioProcessorEditor::secondVowelSelection()
{
    if (secondCurrentVowel == vowel[0]) {
        ...
        audioProcessor.set_secondVowel(1);
    }
        ...
        audioProcessor.set_secondVowel(2);
    }
        ...
        audioProcessor.set_secondVowel(3);
    }
        ...
        audioProcessor.set_secondVowel(4);
    }
    else if (secondCurrentVowel == vowel[4]) {
        secondVowel.setButtonText("A");
        secondVowel.setColour(juce::TextButton::buttonOnColourId, juce::Colours::red.darker(0.2f));
        secondCurrentVowel = vowel[0];
        audioProcessor.set_secondVowel(0);
    }
}
